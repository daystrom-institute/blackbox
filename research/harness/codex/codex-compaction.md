...
topic:
  ...
  - codex
  - compaction
brief: "STUB — Codex 0.136.0, Compaction axis. Nothing mined yet. Read the axis doc for the questions this cell must answer and the subject snapshot for provenance, then mine, confidence-tag, and update the snapshot checklist per the harness charter."
---
...
See the axis: [Compaction](../compaction.md) · subject snapshot: [Codex 0.136.0](codex-0.136.0.md).
