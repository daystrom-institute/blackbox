...
| [kimi-plan-review.md](kimi-plan-review.md) | [`../../scripts/kimi-review.sh`](../../scripts/kimi-review.sh) | Fixed-scope, read-only Kimi review of the checkout-provenance implementation plan, with same-session re-review. |
