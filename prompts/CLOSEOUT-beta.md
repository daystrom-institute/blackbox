...
1. **Capture durable knowledge into crate-/leaf-scoped AGENTS.md** (below)
...
## Crate-/leaf-scoped AGENTS.md upkeep (step 1)

Before committing, walk what the session actually changed and update the
nearest **crate-scoped** AGENTS.md and any **sufficiently-dense-leaf-scoped**
...
- **Match the house voice — sample siblings first.** Read 2–3 existing
  crate/leaf AGENTS.md before writing so density, bolded lead-ins, and tone
