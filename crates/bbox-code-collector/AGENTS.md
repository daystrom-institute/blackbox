...
- This binary is a thin producer. It walks/hashes bounded raw files and, when explicitly enabled per project, captures complete typed Git-history facts. Chunking, Tantivy, embeddings, vectors, edges, activation, and daemon behavior remain corpus-side.
