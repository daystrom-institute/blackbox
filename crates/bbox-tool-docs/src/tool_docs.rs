...
pub const TOOL_DOCS: &[ToolDoc] = &[
    ...
    ToolDoc {
        ...
        category: ToolCategory::Transcripts,
        summary: "Return compact route health, current-process embedding successes, queue depth, and actionable errors. debug adds configuration and routine counters without extra scans. include_coverage requests a source-corpus scan; include_diagnostics requests bounded HNSW diagnostics; recall_probe_route runs a sampled probe. Those scans and probes can be expensive.",
