...
pub mod rust_references;
pub(crate) mod rust_string_enum;
pub mod rust_top_level_deps;
...
pub fn resolve_path(project_dir: Option<&str>, path: &str) -> Result<PathBuf> {
...
pub(crate) fn line_col(source: &str, idx: usize) -> (usize, usize) {
...
pub fn parse_validation_step_for_path(path: &Path) -> Vec<ValidationStep> {
...
pub fn parse_report(root: Node<'_>) -> ParseReport {
