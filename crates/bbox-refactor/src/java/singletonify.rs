...
pub(crate) fn plan_singletonify_java_holder(p: &RefactorPlanParams) -> Result<String> {
    ...
    let inject_ns = crate::java::di_plumbing::InjectNamespace::detect(&parsed.source);
    let singleton_fqcn = match inject_ns {
        crate::java::di_plumbing::InjectNamespace::Javax => "javax.inject.Singleton",
    ...
    edits = crate::java::di_plumbing::dedupe_insertion_edits(edits);
