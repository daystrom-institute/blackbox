...
pub fn plan_migrate_type_usages(p: &crate::RefactorPlanParams) -> Result<String> {
...
mod tests {
    ...
    fn plan_for(
        ...
        let response = plan_migrate_type_usages(&crate::RefactorPlanParams {
            kind: "migrate_rust_type_usages".to_string(),
...
"#,
        ...
        let err = plan_migrate_type_usages(&crate::RefactorPlanParams {
            kind: "migrate_rust_type_usages".to_string(),
            source: source.to_string_lossy().into_owned(),
            target: None,
            item_names: None,
