...
pub(crate) use vaadin_component_extract::plan_java_vaadin_extract_component;
pub(crate) use vaadin_dialog_extract::plan_java_vaadin_extract_dialog_class;
pub(crate) use vaadin_grid_extract::plan_java_vaadin_extract_grid_component;
pub(crate) use vaadin_navigation_helper::plan_java_vaadin_navigation_helper_extract;
pub(crate) use vaadin_route_access::plan_java_vaadin_register_route_access;
...
pub(crate) use vaadin_view_synthesis::plan_java_vaadin_synthesize_view;
...
#[cfg(test)]
mod tests;
mod vaadin_component_extract;
mod vaadin_dialog_extract;
mod vaadin_grid_extract;
mod vaadin_navigation_helper;
mod vaadin_route_access;
mod vaadin_route_inventory;
mod vaadin_static_ui_audit;
mod vaadin_view_structure;
mod vaadin_view_synthesis;
