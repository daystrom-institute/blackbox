...
- Stores/paths: `BLACKBOX_STATE_DIR`, `BLACKBOX_KNOWLEDGE_PATH`,
  ...
  `BLACKBOX_PINS_PATH`, `BLACKBOX_PROJECTS_PATH`, `BLACKBOX_MOUNTS_PATH`,
  `BLACKBOX_PACKETS_DIR`, `BLACKBOX_ARTIFACTS_DIR`, `BRO_HOME`
- Connectors: `BLACKBOX_MOUNT_SYNC_INTERVAL_SECS` (periodic per-mount resync
  loop; default 900, 0 disables) - see
