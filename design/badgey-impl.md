...
Companion to `design/badgey.md`. Each phase below names a discrete
...
(`design/badgey.md` §2.2 dispatching-state recovery).

**Realizes.** `design/badgey.md` §15 OQ #1.
...
`design/badgey.md` §7.1, §7.2 and filter-chain rules denying
`mcp__blackbox__bro_*` for both.

**Realizes.** `design/badgey.md` §2.2, §6.3, §7.
...
**Realizes.** `design/badgey.md` §4.2, §4.3, §6.5, §8.3.
...
**Realizes.** `design/badgey.md` §8.3, §6.3 apply mechanics.
...
**Realizes.** `design/badgey.md` §2.2 wrapper post-processing recovery.
...
**Realizes.** `design/badgey.md` §2.3, §2.5, §8.
...
**Realizes.** `design/badgey.md` §2.2 (wrapper-direct commands).
...
**Realizes.** `design/badgey.md` §2.2 mechanical model.
...
mechanics from `design/badgey.md` §6.3 apply-proposal mechanics.

**Realizes.** `design/badgey.md` §6.3 apply mechanics, §11.6
recovery semantics.
...
**Realizes.** `design/badgey.md` §13.2 cost controls.
...
- Tool descriptions per `design/badgey.md` §4.4 — load-bearing cuing.
...
**Realizes.** `design/badgey.md` §5.3, §9.3.
...
**Realizes.** `design/badgey.md` §10.2.
...
`design/badgey.md` §7.1, §7.2. Installed as the canonical
`brofile:badgey` artifact.

**Realizes.** `design/badgey.md` §7.
...
**Realizes.** `design/badgey.md` §6.3 sub-bro pattern.
...
`[scope]` block (`design/badgey.md` §7.3) at exec / resume time.

**Realizes.** `design/badgey.md` §7.3.
...
(`design/badgey.md` §8.1 table).

**Realizes.** `design/badgey.md` §8.1.
...
**Realizes.** `design/badgey.md` §8.2, §11.6.
...
**Realizes.** `design/badgey.md` §6.5, §6.3 apply mechanics.
...
**Realizes.** `design/badgey.md` §6.5 bounded learning loop.
...
**Realizes.** `design/badgey.md` §12.1, §12.5.
...
criteria (`design/badgey.md` §12.2).

**Realizes.** `design/badgey.md` §12.2.
...
**Realizes.** `design/badgey.md` §12.3.
...
**Realizes.** `design/badgey.md` §12.4.
...
**Realizes.** `design/badgey.md` §7, §10.3.
...
**Realizes.** `design/badgey.md` §10.3.
...
**Scope.** Each failure mode in `design/badgey.md` §11 has a test
exercising the documented mitigation.

**Realizes.** `design/badgey.md` §11.
...
**Scope.** Metrics emission per `design/badgey.md` §13.1.

**Realizes.** `design/badgey.md` §13.
