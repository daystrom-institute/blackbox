...
- **Durable scope minting for non-git sources** (section 8): DECIDED
  2026-08-12 (operator) and IMPLEMENTED by phase 0
  (feat/connector-scope-phase0): grant-time operator-minted
  `connector_source_id` with provider coordinates as observations;
