...
Related: `design/archive/agentic-corpus.md` §7.3 (chunker registry),
`design/archive/agentic-corpus-impl.md` (X-* markers section),
`design/proposed/multimodal-embedding-routing.md` (embedding routing /
