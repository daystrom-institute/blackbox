...
Related: `design/archive/agentic-corpus.md` §7.4 (Tier A vs Tier B),
`design/archive/agentic-corpus-impl.md` Phase S3 (Tier A AST edges
via tree-sitter-language-pack — landed),
`design/archive/agentic-corpus-impl.md` (Y-* markers section).
