---
title: "Code Navigation and Symbolic Exploration \u2014 implementation skeleton"
kind: design
lifecycle: archived
...
Companion to `design/corpus/code-navigation/code-nav-symbolic-exploration.md`. Phases are
...
`design/corpus/code-navigation/code-nav-symbolic-exploration.md`:
