---
title: "Agentic corpus \u2014 implementation skeleton"
kind: design
lifecycle: archived
...
Companion to `design/corpus/agentic-corpus/agentic-corpus.md`. Each phase below names a discrete
...
- Bootstrap this repo: arc completes; `bbox_search(query="agentic-corpus")`
  returns hits from `design/corpus/agentic-corpus/agentic-corpus.md`.
