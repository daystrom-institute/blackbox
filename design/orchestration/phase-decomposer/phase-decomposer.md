---
title: "Phase Decomposer - context-budget-aware execution of large phased plans"
kind: design
lifecycle: partial
...
(`design/orchestration/supervision/supervision.md`): implemented mechanical telemetry observes
...
**supervised subworkflow** (`design/orchestration/supervision/supervision.md`): the implementer
...
subworkflow defined in `design/orchestration/supervision/supervision.md`: mechanical telemetry
...
`design/orchestration/supervision/supervision.md` for the full specification.
