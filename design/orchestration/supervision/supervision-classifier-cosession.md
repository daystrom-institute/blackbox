---
title: "Classifier co-session as workflow-backed atom"
kind: design
lifecycle: archived
...
brief: "Designs the semantic classifier co-session that observes supervised atom execution without controlling it."
---
...
S4-sleep-primitive in `design/orchestration/supervision/supervision-impl.md`, implemented in
phase P3b of `design/orchestration/supervision/supervision-phased-implementation.md`.
