---
title: "runtime allocation tier mapping"
kind: design
lifecycle: archived
...
brief: "Maps provider tiers, runtime allocation ladders, account health, and recovery lane selection."
---
...
`design/orchestration/supervision/acquire-drone.md` is superseded as a dispatch-tool design.
