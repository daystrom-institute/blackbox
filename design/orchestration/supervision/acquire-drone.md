---
title: "acquire_drone - pooled ad hoc bro dispatch for external LLM sessions"
kind: design
lifecycle: archived
...
brief: "Superseded donor design for pooled ad hoc bro dispatch and runtime allocation."
---

Superseded by `runtime-allocation-tier-mapping.md`.
...
`design/orchestration/supervision/runtime-allocation-tier-mapping.md`. The `acquire_drone` MCP
