---
title: "Rust Refactor Expansion - implementation skeleton"
kind: design
lifecycle: archived
...
Companion to `refactor-rust-expansion.md`. Each phase names a
...
(`../refactor-agents-impl.md`) depends on this skeleton — atoms
...
**Realizes.** `design/refactor-tools/rust/refactor-rust-expansion.md` "Boundary — three
semantic tiers".
...
**Realizes.** `design/refactor-tools/rust/refactor-rust-expansion.md` "Plan output size
...
**Realizes.** `design/refactor-tools/rust/refactor-rust-expansion.md` §10 "Runner
...
**Realizes.** `design/refactor-tools/rust/refactor-rust-expansion.md` §10 "Repair
...
**Realizes.** `design/refactor-tools/rust/refactor-rust-expansion.md` §1
...
**Realizes.** `design/refactor-tools/rust/refactor-rust-expansion.md` §1 "FIXME marker
...
**Realizes.** `design/refactor-tools/rust/refactor-rust-expansion.md` §2.
...
**Realizes.** `design/refactor-tools/rust/refactor-rust-expansion.md` §3
...
**Realizes.** `design/refactor-tools/rust/refactor-rust-expansion.md` §4.
...
**Realizes.** `design/refactor-tools/rust/refactor-rust-expansion.md` §5.
...
**Realizes.** `design/refactor-tools/rust/refactor-rust-expansion.md` §8.
...
**Realizes.** `design/refactor-tools/rust/refactor-rust-expansion.md` §9.
...
**Realizes.** `design/refactor-tools/rust/refactor-rust-expansion.md` §10 planner
...
**Realizes.** `design/refactor-tools/rust/refactor-rust-expansion.md` §6.
...
**Realizes.** `design/refactor-tools/rust/refactor-rust-expansion.md` §7.
...
**Realizes.** `design/refactor-tools/rust/refactor-rust-expansion.md` §11.
...
**Realizes.** `design/refactor-tools/rust/refactor-rust-expansion.md` §13.
...
**Realizes.** `design/refactor-tools/rust/refactor-rust-expansion.md` §12.
...
**Realizes.** `design/refactor-tools/rust/refactor-rust-expansion.md` "Cross-Surface
