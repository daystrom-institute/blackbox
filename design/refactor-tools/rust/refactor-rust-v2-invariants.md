---
title: "Rust Refactor - v2 invariants and deferred plan kinds"
kind: design
lifecycle: archived
...
Status detail: proposed v2 follow-ups (deferred items from
`refactor-rust-expansion-impl` non-goals; refactor-agents v1 has landed).
Related: `refactor-rust-expansion.md`,
`refactor-rust-expansion-impl.md` ("Non-goals (this skeleton)"
and "Cross-surface invariants" sections),
`../refactor-agents-impl.md` (v1 consumer that exercises these
...
Source: `design/refactor-tools/rust/refactor-rust-expansion-impl.md` RX-V1.
...
Source: `design/refactor-tools/rust/refactor-rust-expansion-impl.md` RX-V2.
...
Source: `design/refactor-tools/rust/refactor-rust-expansion-impl.md` non-goals.
