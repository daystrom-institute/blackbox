---
title: "AST-Grounded Restructure Execution Plan"
kind: design
lifecycle: archived
...
bbox_refactor_run(
  ...
  steps=[
    ...
    {"op":"plan","kind":"rewrite_rust_item_visibility","source":"src/packets/ast.rs","item_names":["review_lattice","review_prefix_inference","infer_classification","infer_classification_detailed","validate_path","validate_predicate","collect_apply_refs","rule_antecedents_referencing","collect_apply_by_id","check_apply_expect_against_lattice","default_confidence"],"item_kinds":["function_item"],"visibility":"pub(super)"},
...
`rewrite_rust_item_visibility` after extraction only for formerly-private
...
bbox_refactor_run(
  ...
  steps=[
    ...
    {"op":"plan","kind":"rewrite_rust_field_visibility","source":"src/server/state.rs","item_names":["SharedState","BlackboxServer","SignalEvent","WebhookDelivery","ArcSnapshot"],"visibility":"pub(crate)"},
    {"op":"plan","kind":"rewrite_rust_field_visibility","source":"src/server/progress.rs","item_names":["DispatchFilters"],"visibility":"pub(crate)"},
