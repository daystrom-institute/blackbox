...
> **Status (2026-08-07): code span COMPLETE and certified; operational cut
> completed; post-cut repair open.** P6-A, P6-B, and P6-C are implemented,
> cluster-verified, and closed at the phase's closing code review (CHECKPOINT
> PASS, round 3, no findings); the certified code span is
> `f22c10b9..c25b8c67` and remains frozen. The operational sequence (P6-D
> through P6-H below) was superseded by operator directive with the compressed
> one-session runbook, and that cut completed. Production is now deliberately
> stopped after post-cut liveness and durability defects were diagnosed. The
> bounded repair is specified in
> [`durable-project-catalog-phase6-post-cut-repair-impl.md`](durable-project-catalog-phase6-post-cut-repair-impl.md).
> The milestone text below remains the formal reference for what the cut
> proved. Bridge retirement remains a later phase and is still gated by
> section 10.3.
