...
pub fn plan_public_api_guard(p: &crate::refactor::RefactorPlanParams) -> Result<String> {
...
mod tests {
    ...
    fn p(project_dir: Option<&Path>, source: &str) -> crate::refactor::RefactorPlanParams {
