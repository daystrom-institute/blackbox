...
## Protocol markers — RA-S1 lint signals

The RA-S1 manifest lint warns when an atom's filled-in template is
missing any of these strings (case-sensitive substring match):
